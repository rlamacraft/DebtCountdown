...
var _user$project$Main$remainderAsHtml = function (remainder) {
	var commas = function (str) {
		return (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(str),
			3) > 0) ? A2(
			_elm_lang$core$Basics_ops['++'],
			A3(_elm_lang$core$String$slice, 0, -3, str),
			A2(
				_elm_lang$core$Basics_ops['++'],
				',',
				A3(
	...
	if (_p0.ctor === 'MissingInputs') {
		...
		return _elm_lang$html$Html$text(
			A2(
				_elm_lang$core$Basics_ops['++'],
				commas(
					_elm_lang$core$Basics$toString(_p1.pounds)),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'.',
					leftPad(
...
var _user$project$Main$moneySubtractMoney = F2(
	function (a, b) {
		...
		var aInPenies = (a.pounds * 100) + a.pence;
		var subtraction = aInPenies - bInPenies;
		var pounds = _elm_lang$core$Basics$floor(
			_elm_lang$core$Basics$toFloat(subtraction) / 100);
		var penies = _elm_lang$core$Basics$ceiling(
			_elm_lang$core$Basics$toFloat(subtraction)) - (pounds * 100);
		return {pounds: pounds, pence: penies};
	});
var _user$project$Main$multiplyMoneyByTime = F2(
	function (mV, t) {
		var mVInPence = (100 * mV.pounds) + mV.pence;
		var multiplication = _elm_lang$core$Basics$toFloat(mVInPence) * t;
		var pounds = _elm_lang$core$Basics$floor(multiplication / 100);
		var penies = _elm_lang$core$Basics$ceiling(multiplication) - (pounds * 100);
		return {pounds: pounds, pence: penies};
	});
var _user$project$Main$divideMoneyByTime = F2(
	function (mV, t) {
		var mVInPence = (100 * mV.pounds) + mV.pence;
		var division = _elm_lang$core$Basics$toFloat(mVInPence) / t;
		var pounds = _elm_lang$core$Basics$floor(division / 100);
		var penies = _elm_lang$core$Basics$ceiling(division) - (pounds * 100);
		return {pounds: pounds, pence: penies};
	});
var _user$project$Main$actuallyCalculateRemainder = F4(
	function (totalOwed, startDate, endDate, currentTime) {
		var endTime = _elm_lang$core$Date$toTime(endDate);
		var startTime = _elm_lang$core$Date$toTime(startDate);
		var totalTime = _elm_lang$core$Time$inSeconds(endTime) - _elm_lang$core$Time$inSeconds(startTime);
		var moneyPerUnitTime = A2(_user$project$Main$divideMoneyByTime, totalOwed, totalTime);
		var elapsedTime = _elm_lang$core$Time$inSeconds(currentTime) - _elm_lang$core$Time$inSeconds(startTime);
		var remainder = A2(
			_user$project$Main$moneySubtractMoney,
			totalOwed,
			A2(_user$project$Main$multiplyMoneyByTime, totalOwed, elapsedTime / totalTime));
		return remainder;
	});
var _user$project$Main$MonetaryValue = F2(
	function (a, b) {
...
var _user$project$Main$NoInputValue = {ctor: 'NoInputValue'};
var _user$project$Main$CalculatedValue = function (a) {
	return {ctor: 'CalculatedValue', _0: a};
};
var _user$project$Main$MissingInputs = function (a) {
	return {ctor: 'MissingInputs', _0: a};
};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		totalOwed: _user$project$Main$NoInputValue,
...
var _user$project$Main$NewTotalDebt = function (a) {
	return {ctor: 'NewTotalDebt', _0: a};
};
var _user$project$Main$NewEndDate = function (a) {
	return {ctor: 'NewEndDate', _0: a};
};
var _user$project$Main$NewStartDate = function (a) {
	return {ctor: 'NewStartDate', _0: a};
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('outputs'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Main$remainderAsHtml(model.remainder),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
							...
							{ctor: '[]'},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$NewStartDate),
											_1: {
												ctor: '::',
												_0: A2(_elm_lang$html$Html_Attributes$attribute, 'placeholder', 'YYYY-MM-DD'),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
						...
						_1: {
								...
								{ctor: '[]'},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$NewEndDate),
												_1: {
													ctor: '::',
													_0: A2(_elm_lang$html$Html_Attributes$attribute, 'placeholder', 'YYYY-MM-DD'),
													_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Total Original Debt'),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$input,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$NewTotalDebt),
													_1: {
														ctor: '::',
														_0: A2(_elm_lang$html$Html_Attributes$attribute, 'placeholder', '#####'),
														_1: {ctor: '[]'}
													}
												},
												{ctor: '[]'}),
...
var _user$project$Main$UpdateOutput = {ctor: 'UpdateOutput'};
